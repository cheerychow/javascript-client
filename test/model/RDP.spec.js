...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheeryChowRecipeApi.RDP();
  });
  ...
  describe('RDP', function() {
    it('should create an instance of RDP', function() {
      // uncomment below and update the code to test RDP
      //var instane = new CheeryChowRecipeApi.RDP();
      //expect(instance).to.be.a(CheeryChowRecipeApi.RDP);
    });
