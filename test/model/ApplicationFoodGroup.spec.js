...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheeryChowRecipeApi.ApplicationFoodGroup();
  });
  ...
  describe('ApplicationFoodGroup', function() {
    it('should create an instance of ApplicationFoodGroup', function() {
      // uncomment below and update the code to test ApplicationFoodGroup
      //var instane = new CheeryChowRecipeApi.ApplicationFoodGroup();
      //expect(instance).to.be.a(CheeryChowRecipeApi.ApplicationFoodGroup);
    });
