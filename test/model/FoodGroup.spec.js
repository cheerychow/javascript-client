...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheeryChowRecipeApi.FoodGroup();
  });
  ...
  describe('FoodGroup', function() {
    it('should create an instance of FoodGroup', function() {
      // uncomment below and update the code to test FoodGroup
      //var instane = new CheeryChowRecipeApi.FoodGroup();
      //expect(instance).to.be.a(CheeryChowRecipeApi.FoodGroup);
    });
