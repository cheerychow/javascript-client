...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheeryChowRecipeApi.AvgTotal();
  });
  ...
  describe('AvgTotal', function() {
    it('should create an instance of AvgTotal', function() {
      // uncomment below and update the code to test AvgTotal
      //var instane = new CheeryChowRecipeApi.AvgTotal();
      //expect(instance).to.be.a(CheeryChowRecipeApi.AvgTotal);
    });
