...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheeryChowRecipeApi.IngredientFood();
  });
  ...
  describe('IngredientFood', function() {
    it('should create an instance of IngredientFood', function() {
      // uncomment below and update the code to test IngredientFood
      //var instane = new CheeryChowRecipeApi.IngredientFood();
      //expect(instance).to.be.a(CheeryChowRecipeApi.IngredientFood);
    });
