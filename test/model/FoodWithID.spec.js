...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheeryChowRecipeApi.FoodWithID();
  });
  ...
  describe('FoodWithID', function() {
    it('should create an instance of FoodWithID', function() {
      // uncomment below and update the code to test FoodWithID
      //var instane = new CheeryChowRecipeApi.FoodWithID();
      //expect(instance).to.be.a(CheeryChowRecipeApi.FoodWithID);
    });
