...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheeryChowRecipeApi.MiniFood();
  });
  ...
  describe('MiniFood', function() {
    it('should create an instance of MiniFood', function() {
      // uncomment below and update the code to test MiniFood
      //var instane = new CheeryChowRecipeApi.MiniFood();
      //expect(instance).to.be.a(CheeryChowRecipeApi.MiniFood);
    });
