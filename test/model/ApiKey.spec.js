...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheeryChowRecipeApi.ApiKey();
  });
  ...
  describe('ApiKey', function() {
    it('should create an instance of ApiKey', function() {
      ...
      //var instane = new CheeryChowRecipeApi.ApiKey();
      //expect(instance).to.be.a(CheeryChowRecipeApi.ApiKey);
    });
    ...
    it('should have the property expireReason (base name: "expire_reason")', function() {
      // uncomment below and update the code to test the property expireReason
      //var instane = new CheeryChowRecipeApi.ApiKey();
      //expect(instance).to.be();
    });
