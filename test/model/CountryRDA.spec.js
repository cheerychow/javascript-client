...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheeryChowRecipeApi.CountryRDA();
  });
  ...
  describe('CountryRDA', function() {
    it('should create an instance of CountryRDA', function() {
      // uncomment below and update the code to test CountryRDA
      //var instane = new CheeryChowRecipeApi.CountryRDA();
      //expect(instance).to.be.a(CheeryChowRecipeApi.CountryRDA);
    });
