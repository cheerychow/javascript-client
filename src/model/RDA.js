...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CheeryChowRecipeApi.RDA = factory(root.CheeryChowRecipeApi.ApiClient);
  }
  ...
  /**
   * The RDA model module.
   * @module model/RDA
   * @version 0.0.2
   */

  /**
   * Constructs a new <code>RDA</code>.
   * @alias module:model/RDA
   * @class
   */
  ...
  /**
   * Constructs a <code>RDA</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RDA} obj Optional instance to populate.
   * @return {module:model/RDA} The populated <code>RDA</code> instance.
   */
