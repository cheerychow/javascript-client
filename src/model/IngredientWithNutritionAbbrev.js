...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Ingredient', 'model/NutritionAbbrev'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Ingredient'), require('./NutritionAbbrev'));
  } else {
    // Browser globals (root is window)
    if (!root.CheeryChowRecipeApi) {
      root.CheeryChowRecipeApi = {};
    }
    root.CheeryChowRecipeApi.IngredientWithNutritionAbbrev = factory(root.CheeryChowRecipeApi.ApiClient, root.CheeryChowRecipeApi.Ingredient, root.CheeryChowRecipeApi.NutritionAbbrev);
  }
}(this, function(ApiClient, Ingredient, NutritionAbbrev) {
  'use strict';
  ...
  /**
   * The IngredientWithNutritionAbbrev model module.
   * @module model/IngredientWithNutritionAbbrev
   * @version 0.0.2
   */

  /**
   * Constructs a new <code>IngredientWithNutritionAbbrev</code>.
   * @alias module:model/IngredientWithNutritionAbbrev
   * @class
  ...
  /**
   * Constructs a <code>IngredientWithNutritionAbbrev</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/IngredientWithNutritionAbbrev} obj Optional instance to populate.
   * @return {module:model/IngredientWithNutritionAbbrev} The populated <code>IngredientWithNutritionAbbrev</code> instance.
   */
