...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CheeryChowRecipeApi.ApiKey = factory(root.CheeryChowRecipeApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('api_key_id')) {
        obj['api_key_id'] = ApiClient.convertToType(data['api_key_id'], 'Integer');
      }
      if (data.hasOwnProperty('created')) {
        obj['created'] = ApiClient.convertToType(data['created'], 'Integer');
      }
      if (data.hasOwnProperty('expire_reason')) {
        obj['expire_reason'] = ApiClient.convertToType(data['expire_reason'], 'String');
      }
      if (data.hasOwnProperty('expires')) {
        obj['expires'] = ApiClient.convertToType(data['expires'], 'Integer');
      }
  ...
  /**
   * @member {String} expire_reason
   */
  exports.prototype['expire_reason'] = undefined;
  /**
   * @member {Integer} expires
   */
