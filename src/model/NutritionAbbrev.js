...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BaseNutritionAbbrev'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BaseNutritionAbbrev'));
  } else {
    // Browser globals (root is window)
    if (!root.CheeryChowRecipeApi) {
      root.CheeryChowRecipeApi = {};
    }
    root.CheeryChowRecipeApi.NutritionAbbrev = factory(root.CheeryChowRecipeApi.ApiClient, root.CheeryChowRecipeApi.BaseNutritionAbbrev);
  }
}(this, function(ApiClient, BaseNutritionAbbrev) {
  'use strict';
  ...
  /**
   * The NutritionAbbrev model module.
   * @module model/NutritionAbbrev
   * @version 0.0.2
   */

  /**
   * Constructs a new <code>NutritionAbbrev</code>.
   * @alias module:model/NutritionAbbrev
   * @class
  ...
  /**
   * Constructs a <code>NutritionAbbrev</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NutritionAbbrev} obj Optional instance to populate.
   * @return {module:model/NutritionAbbrev} The populated <code>NutritionAbbrev</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('nut_food_id')) {
        obj['nut_food_id'] = ApiClient.convertToType(data['nut_food_id'], 'Integer');
      }
